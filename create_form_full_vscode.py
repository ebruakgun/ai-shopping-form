...
def main():
    ...
    # ---------------------------
    # 3️⃣ Form açıklaması için update
    # ---------------------------
    update_requests = [
        {
            "updateFormInfo": {
                "info": {
                    "description": "This survey helps us understand how users interact with AI shopping assistants. Thanks for joining!"
                },
    ...
    # ---------------------------
    # 5️⃣ Formu güncelle (description + sorular)
    # ---------------------------
    service.forms().batchUpdate(formId=form_id, body={"requests": update_requests + questions}).execute()
